...
User.create(first_name: "Charlie", last_name: "Carpene", age: "29", origin: "Montpellier", description: "J'aime les chips", email: "charlie@charlie.com", password: "password1")
User.create(first_name: "Marie", last_name: "Distinguin", age: "27", origin: "Perigeux", description: "J'aime les cacahuètes", email: "marie@marie.com", password: "password2")
User.create(first_name: "Joannice", last_name: "Thevenon", age: "25", origin: "Lyon", description: "J'aime les pistaches", email: "jonas@jonas.com", password: "password3")
